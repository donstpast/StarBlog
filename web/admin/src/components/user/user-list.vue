  ...
  <div>
    <el-card class="cardBox">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <!-- 新增按钮 -->
          <el-button type="primary" @click="addUserFormVisible = true"> 新增 </el-button>
        </el-col>
      </el-row>
      <!-- 用户列表 -->
      <el-table stripe style="width: 100%" class="userTable" :data="userList">
    ...
    >
      ...
      >
        ...
        <el-form-item label="权限" :label-width="formLabelWidth" prop="role">
          <el-select v-model="addUserForm.role" @change="roleChange">
    ...
    >
      ...
      >
        <el-form-item label="用户名" :label-width="formLabelWidth" prop="username">
          <el-input v-model="editUserForm.username" :clearable="true" autocomplete="off" />
        </el-form-item>
        <el-form-item label="密码" :label-width="formLabelWidth" prop="password">
          <el-input
        ...
        <el-form-item label="权限" :label-width="formLabelWidth" prop="role">
          <el-select v-model="editUserForm.role" @change="roleChange">
            <el-option label="普通用户" value="2" />
            <el-option label="管理员" value="1" />
          </el-select>
        </el-form-item>
...
const deleteUser = async (userList: UserList) => {
  try {
    ...
    const confirmResult = await ElMessageBox.confirm('确认要删除该用户信息么？', '提示', {
