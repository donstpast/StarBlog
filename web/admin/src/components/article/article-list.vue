  ...
  <div>
    <el-card class="cardBox">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <!-- 新增按钮 -->
          <el-button type="primary" @click="addArticleBtn()"> 撰写文章 </el-button>
        </el-col>
      ...
      <!-- 文章列表 -->
      <el-table stripe style="width: 100%" class="articleTable" :data="articleList">
        ...
        <el-table-column label="操作" align="center">
          <template #default="scope">
            <!-- 编辑按钮 -->
            <el-button size="small" @click="editArticleBtn(scope.row)">Edit </el-button>
            <!-- 删除按钮 -->
...
const deleteArticle = async (articleList: ArticleList) => {
  try {
    ...
    const confirmResult = await ElMessageBox.confirm('确认要删除该文章信息么？', '提示', {
